...
document.write("<p>version 0.1, created by Zhao Xiaoqi</p>");
var beginpara = "<p>";
var endpara = "</p>";

//==================================================================================================
var customer_name;	// 客户姓名，free text
var contact_mobile;	// 联系方式，can have validation rule
...
document.write(beginpara + "Equipment Price (RMB):	" + equipment_price + endpara);
document.write(beginpara + "Down Payment Amount (RMB):	" + down_payment_amount + endpara);
...
document.write(beginpara + "Total Insurance Fee (RMB):	" + insurance_fee_amount + endpara);

document.write(beginpara + "Handling Fee (RMB):	" + handling_fee_amount + endpara);

document.write(beginpara + "S/D Amount (RMB):	" + sd_amount + endpara);

document.write(beginpara + "Total Down Payment Amount (RMB):	" + total_down_payment_amount + endpara);

document.write(beginpara + "Net Financed Amount (RMB):	" + net_financed_amount + endpara);

document.write(beginpara + "Monthly Payment Amount (RMB):	" + monthly_payment_amount + endpara);